...
# Lizzy used this to make dat work. setwd("/Users/blake/Desktop/Data_Course")
...
match("41mm", dat$Headwidth)


# CONVERT THOSE TO "41.000"
replace(dat$Headwidth, 1031 == "41mm", "41.000")
